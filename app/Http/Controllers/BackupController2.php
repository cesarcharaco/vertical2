...
class BackupController extends Controller
{
    ...
    public function create()
    {
        ...
        try {
            ...
            //$command = "$mysqlPath --user=root --password=" . env('DB_PASSWORD') . " --host=" . env('DB_HOST') . " vertical  > " . storage_path() . "/app/public/backups/" . $filename."  2>&1";
            $returnVar = NULL;
            $output  = NULL;
            
            $var=exec($command, $output, $returnVar);
            //dd($var);
