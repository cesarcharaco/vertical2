                ...
                <div class="card-body card-block">
                    <!--<form action="{{ route('graficas.store') }}" method="POST" enctype="multipart/form-data" class="">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col col-md-3">
                                <label for="num_bloques" class=" form-control-label"><b style="color:red;">*</b>Empleado:</label>
                            </div>
                            <div class="col-12 col-md-3">
                                <select name="id_empleado" id="id_empleado" required="required" class="form-control">
                    ...
                    <form action="#" method="POST" enctype="multipart/form-data" class="">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-12">
                                Asistencia del empleado: <b>{{$empleado->nombres}} {{$empleado->apellidos}} C.I.: {{$empleado->nacionalidad}}-{{$empleado->cedula}}</b><br>
